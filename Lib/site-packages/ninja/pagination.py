...
from typing import get_args as get_collection_args
...
from ninja.utils import (contribute_operation_args,
                         contribute_operation_callback, is_async_callable)
...
def paginate(func_or_pgn_class: Any = NOT_SET, **paginator_params: Any) -> Callable:
    ...
    pagination_class: type[PaginationBase | AsyncPaginationBase] = import_string(
