...
from typing import (TYPE_CHECKING, Annotated, Any, ClassVar, Dict, ForwardRef,
                    Generic, List)
from typing import Literal
from typing import Literal as ExtLiteral
from typing import (Optional, Tuple, Type, TypeVar, Union, _UnionGenericAlias,
                    cast)
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(
        cls: type[GenericModelT], params: type[Any] | tuple[type[Any], ...]
    ) -> type[Any]:
