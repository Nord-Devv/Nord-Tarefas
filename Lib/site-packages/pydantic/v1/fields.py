...
from typing import (TYPE_CHECKING, Annotated, Any, DefaultDict, Deque, Dict,
                    Final, ForwardRef, FrozenSet, List, Optional, Set, Tuple,
                    Type, TypeVar, Union)
...
from pydantic.v1.typing import (NoArgAnyCallable, convert_generics,
                                display_as_type, get_args, get_origin,
                                is_finalvar, is_literal_type, is_new_type,
                                is_none_type, is_typeddict,
                                is_typeddict_special, is_union,
                                new_type_supertype)
from pydantic.v1.utils import (PyObjectStr, Representation, ValueItems,
                               get_discriminator_alias_and_values,
                               get_unique_discriminator_alias,
                               lenient_isinstance, lenient_issubclass,
                               sequence_like, smart_deepcopy)
...
class ModelField(Representation):
    ...
    def __init__(
        ...
        *,
        ...
        self.sub_fields_mapping: dict[
            str, "ModelField"
        ] | None = None  # used for discriminated union
    ...
    def _validate_sequence_like(  # noqa: C901 (ignore complexity)
        ...
        converted: list[Any] | set[Any] | frozenset[Any] | tuple[Any, ...] | Iterator[
            Any
        ] | Deque[Any] = result
