    ...
    def _read_header(self, execute=EX_CONSTRUCT):
        ...
        if b & 0b10000000 == 0:
            ...
            if self._max_ext_len < 1:
                raise ValueError(
                    "{} exceeds max_ext_len({})".format(1, self._max_ext_len)
                )
            self._reserve(2)
            ...
            if self._max_ext_len < 2:
                raise ValueError(
                    "{} exceeds max_ext_len({})".format(2, self._max_ext_len)
                )
            self._reserve(3)
            ...
            if self._max_ext_len < 4:
                raise ValueError(
                    "{} exceeds max_ext_len({})".format(4, self._max_ext_len)
                )
            self._reserve(5)
            ...
            if self._max_ext_len < 8:
                raise ValueError(
                    "{} exceeds max_ext_len({})".format(8, self._max_ext_len)
                )
            self._reserve(9)
            ...
            if self._max_ext_len < 16:
                raise ValueError(
                    "{} exceeds max_ext_len({})".format(16, self._max_ext_len)
                )
            self._reserve(17)
